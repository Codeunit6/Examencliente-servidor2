...
Route::get('/unidad1-1',[basedataController::class, 'mostrarinformacion1'])->name('unidad1-1');
Route::get('/unidad1-2',[basedataController::class, 'mostrarinformacion2'])->name('unidad1-2');
Route::get('/unidad1-3',[basedataController::class, 'mostrarinformacion3'])->name('unidad1-3');
Route::get('/unidad1-4',[basedataController::class, 'mostrarinformacion4'])->name('unidad1-4');
Route::get('/unidad1-5',[basedataController::class, 'mostrarinformacion5'])->name('unidad1-5');
Route::get('/unidad1-6',[basedataController::class, 'mostrarinformacion6'])->name('unidad1-6');
Route::get('/unidad1-7',[basedataController::class, 'mostrarinformacion7'])->name('unidad1-7');
Route::get('/unidad1-8',[basedataController::class, 'mostrarinformacion8'])->name('unidad1-8');
Route::get('/unidad1-9',[basedataController::class, 'mostrarinformacion9'])->name('unidad1-9');
Route::get('/home3',[basedataController::class, 'menu'])->name('home3');
Route::get('/home4',[basedataController::class, 'menu2'])->name('home4');

Route::get('/unidad1eleccion', function(){
    $social = new informacion();
    $social->facebook="https://www.facebook.com/BlackF.art/";
    $social->git="https://github.com/Codeunit6?tab=repositories";
    $social->twitter="https://twitter.com/hackingzone";
    return view('blog.inicioeleccion', ['social'=>$social]);
})->name('inicioeleccion');

Route::get('/unidad1/basedata', function(){
    $social = new informacion();
    $social->facebook="https://www.facebook.com/BlackF.art/";
    $social->git="https://github.com/Codeunit6?tab=repositories";
    $social->twitter="https://twitter.com/hackingzone";
    return view('blog.bdseleccion', ['social'=>$social]);
})->name('bdseleccion');
Route::get('/baseusario',[basedataController::class, 'tablausuario'])->name('base1');
Route::get('/basedatos',[basedataController::class, 'tablaprogramador'])->name('base2');
Route::get('/unidad2', function(){
    $social = new informacion();
    $social->facebook="https://www.facebook.com/BlackF.art/";
    $social->git="https://github.com/Codeunit6?tab=repositories";
    $social->twitter="https://twitter.com/hackingzone";
    return view('blog.unidad2eleccion', ['social'=>$social]);
})->name('unidad2');
Route::get('/unidad2-1',[unidad2Controller::class, 'mostrarinformacion1'])->name('unidad2-1');
Route::get('/unidad2-2',[unidad2Controller::class, 'mostrarinformacion2'])->name('unidad2-2');
Route::get('/unidad2-3',[unidad2Controller::class, 'mostrarinformacion3'])->name('unidad2-3');
Route::get('/unidad2-4',[unidad2Controller::class, 'mostrarinformacion4'])->name('unidad2-4');
Route::get('/unidad2-5',[unidad2Controller::class, 'mostrarinformacion5'])->name('unidad2-5');
Route::get('/unidad2-6',[unidad2Controller::class, 'mostrarinformacion6'])->name('unidad2-6');
Route::get('/unidad2-7',[unidad2Controller::class, 'mostrarinformacion7'])->name('unidad2-7');
Route::get('/unidad2-8',[unidad2Controller::class, 'mostrarinformacion8'])->name('unidad2-8');
Route::get('/unidad2-9',[unidad2Controller::class, 'mostrarinformacion9'])->name('unidad2-9');
Route::get('/unidad2-10',[unidad2Controller::class, 'mostrarinformacion10'])->name('unidad2-10');
Route::get('/unidad2-11',[unidad2Controller::class, 'mostrarinformacion11'])->name('unidad2-11');
Route::get('/unidad2-12',[unidad2Controller::class, 'mostrarinformacion12'])->name('unidad2-12');
Route::get('/unidad2-13',[unidad2Controller::class, 'mostrarinformacion13'])->name('unidad2-13');
Route::get('/unidad2-14',[unidad2Controller::class, 'mostrarinformacion14'])->name('unidad2-14');
Route::get('/unidad2-15',[unidad2Controller::class, 'mostrarinformacion15'])->name('unidad2-15');
Route::get('/unidad2-16',[unidad2Controller::class, 'mostrarinformacion16'])->name('unidad2-16');
Route::get('/unidad2-17',[unidad2Controller::class, 'mostrarinformacion17'])->name('unidad2-17');

Route::get('/home7',[unidad2Controller::class, 'menu'])->name('home7');
Route::get('/home8',[unidad2Controller::class, 'menu2'])->name('home8');
Route::get('/home9',[unidad2Controller::class, 'menu3'])->name('home9');
Route::get('/home10',[unidad2Controller::class, 'menu4'])->name('home10');
Route::get('/home11',[unidad2Controller::class, 'menu5'])->name('home11');
Route::get('/unidad2/tablaprogramador',[unidad2Controller::class, 'tablaprogramador'])->name('tablap');
Route::get('/unidad2/tablausuario',[unidad2Controller::class, 'tablausuario'])->name('tablau');
Route::get('/unidad2/basedata', function(){
    $social = new informacion();
    $social->facebook="https://www.facebook.com/BlackF.art/";
    $social->git="https://github.com/Codeunit6?tab=repositories";
    $social->twitter="https://twitter.com/hackingzone";
    return view('blog.seleccionarbd', ['social'=>$social]);
})->name('seleccionarbd');