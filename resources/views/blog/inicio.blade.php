...
<html lang="en">
    ...
    <body>
        ...
        <!-- Main Content-->
        <div class="d-flex justify-content-center"><a class="btn btn-primary text-uppercase" href="{{route('inicioeleccion')}}">UNIDAD I →</a></div>
        <br>
        <div class="d-flex justify-content-center"><a class="btn btn-primary text-uppercase" href="{{route('unidad2')}}">UNIDAD II →</a></div>
        <br>
