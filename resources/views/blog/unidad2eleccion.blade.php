...
<html lang="en">
    ...
    <body>
        ...
        <header class="masthead" style="background-image: url('../assets/img/portadaunidad2.jpg')">
        ...
        <!-- Main Content-->
        <div class="d-flex justify-content-center"><a class="btn btn-primary text-uppercase" style="width: 700px;" href="{{route('home7')}}">UNIDAD II INVESTIGACIONES →</a></div>
        <br>
        <div class="d-flex justify-content-center" id="unidad2"><a class="btn btn-primary text-uppercase" style="width: 700px;" href="{{route('seleccionarbd')}}">BASE DE DATOS →</a></div>
        <br>
        <!-- Footer-->
