...
@section('head')
<header class="masthead" style="background-image: url('assets/img/portadas/Unidad2-7.jpg')">
            ...
            <div class="row">
                    <div class="col-sm">
                        <div class="d-flex justify-content-start">
                            <a class="btn btn-primary text-uppercase justify-content-start" href="{{route('home8')}}">🠔 Anterior tema</a>
                        </div>
                    </div>
    
                    <div class="col-sm">
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-primary text-uppercase" href="{{route('home10')}}">Siguiente tema →</a>
                        </div>
                    </div>
                </div>    
        </div>
